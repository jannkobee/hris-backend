    ...
    public function show(AppSettingService $settings): JsonResponse
    {
        ...
        return response()->json([
            'data' => [
                ...
                'host' => config('broadcasting.connections.reverb.public.host', config('broadcasting.connections.reverb.options.host')),
                'port' => (int) config('broadcasting.connections.reverb.public.port', config('broadcasting.connections.reverb.options.port')),
                'scheme' => config('broadcasting.connections.reverb.public.scheme', config('broadcasting.connections.reverb.options.scheme')),
            ],
        ]);
    }
}

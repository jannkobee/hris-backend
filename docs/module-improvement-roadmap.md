...
### In Progress & Planned Improvements
- [ ] **Receipt Upload & Preview UI:** Support image/PDF attachments in `BenefitsExpenses.vue`.
...
- [ ] **Philippine De Minimis Ceiling Tracking:** Enforce non-taxable limits (e.g., Rice Subsidy ₱2,000/mo, Clothing ₱6,000/yr).

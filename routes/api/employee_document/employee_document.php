...
Route::middleware('plan:employee_documents')->group(function (): void {
    Route::controller(EmployeeDocumentController::class)->group(function (): void {
        ...
        Route::post('employees/{employee}/documents', 'store')->middleware('permission:manage-employee-documents')->name('employees.documents.store');
        Route::put('employee-documents/{document}', 'update')->middleware('permission:manage-employee-documents')->name('employee-documents.update');
        Route::delete('employee-documents/{document}', 'destroy')->middleware('permission:manage-employee-documents')->name('employee-documents.destroy');
